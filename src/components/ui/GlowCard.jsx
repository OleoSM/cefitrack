...
const GLOW_COLORS = {
  ...
  amber:  { base: 35,  spread: 180 },
  blue:   { base: 220, spread: 180 },
  emerald:{ base: 150, spread: 180 },
  purple: { base: 280, spread: 180 },
}
...
/**
 * GlowCard — card con spotlight de borde que sigue al cursor.
 * Props:
  ...
  return (
    <>
      ...
      <div
        ref={cardRef}
        data-glow
        className={`relative rounded-2xl p-5 backdrop-blur-sm ${className}`}
        style={{
          '--base':              base,
          '--spread':            spread,
          '--radius':            '16',
          ...
          backgroundImage: `radial-gradient(
            ...
            calc(var(--x,0) * 1px) calc(var(--y,0) * 1px),
            hsl(var(--hue,210) 80% 65% / 0.07), transparent
          )`,
